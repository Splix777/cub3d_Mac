...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/09/13 16:13:33 by fsalazar          #+#    #+#             */
/*   Updated: 2023/09/13 16:14:40 by fsalazar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	printf("Floor: %d, %d, %d\n", game->texture.floor.r, game->texture.floor.g,
		game->texture.floor.b);
	printf("Ceiling: %d, %d, %d\n", game->texture.ceiling.r,
		game->texture.ceiling.g, game->texture.ceiling.b);
	printf("Floor Hex: %lx\n", rgb_to_hex(game, "F"));
